...
public class LittleSuperMarket {
    ...
    public MerchandiseBeta[] merchandises;
    ...
    public LittleSuperMarket(String superMarketName, String address, int parkingCount,
        ...
        merchandises = new MerchandiseBeta[merchandiseCount];
        for (int i = 0; i < merchandises.length; i++) {
            double purchasePrice = Math.random() * 200;
            // 创建并给商品的属性赋值
            MerchandiseBeta m = new MerchandiseBeta(
                    "商品" + i,
                    "ID" + i,
                    count,
    ...
    public void setMerchandises(MerchandiseBeta[] merchandises) {
     ...
     * @return
     */
    public MerchandiseBeta getBiggestProfitMerchandise() {
        MerchandiseBeta curr = null;
        for (int i = 0; i < merchandises.length; i++) {
            MerchandiseBeta m = merchandises[i];
            // 这个逻辑有问题吗？相同的利润怎么判断？
     ...
     * @return
     */
    public MerchandiseBeta getMerchandiseOf(int merchandiseIndex) {
